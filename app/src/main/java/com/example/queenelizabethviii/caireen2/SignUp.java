...
public class SignUp extends AppCompatActivity {
    ...
    //DatabaseHelper helper = new DatabaseHelper(this); //connect to DatabaseHelper class
    ...
    public void registerUser() {
        ...
        if (firstnamestr.isEmpty()||lastnamestr.isEmpty()||emailstr.isEmpty()||passstr.isEmpty()||pass2str.isEmpty()){
            Toast.makeText(SignUp.this, "Complete details first.", Toast.LENGTH_SHORT);
        }
        else if (firstnamestr.isEmpty()&&lastnamestr.isEmpty()&&emailstr.isEmpty()&&passstr.isEmpty()&&pass2str.isEmpty()){
            Toast.makeText(SignUp.this, "You didn't put anything.", Toast.LENGTH_SHORT);
        }
        else {
